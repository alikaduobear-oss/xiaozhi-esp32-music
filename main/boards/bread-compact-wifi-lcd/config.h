...
// 使用 Simplex I2S 模式（麦克风和功放使用不同引脚）
#define AUDIO_I2S_METHOD_SIMPLEX

#ifdef AUDIO_I2S_METHOD_SIMPLEX

// 麦克风 MS4030 (输入)
#define AUDIO_I2S_MIC_GPIO_WS   GPIO_NUM_8      // 麦克风 WS (LRC)
#define AUDIO_I2S_MIC_GPIO_SCK  GPIO_NUM_9      // 麦克风 SCK (BCLK)
#define AUDIO_I2S_MIC_GPIO_DIN  GPIO_NUM_10     // 麦克风 DIN (数据输出到ESP32)

// 功放 MAX98357 (输出)
#define AUDIO_I2S_SPK_GPIO_DOUT GPIO_NUM_15     // 功放 DIN (数据输入)
#define AUDIO_I2S_SPK_GPIO_BCLK GPIO_NUM_13     // 功放 BCLK
#define AUDIO_I2S_SPK_GPIO_LRCK GPIO_NUM_14     // 功放 LRCK (WS)
